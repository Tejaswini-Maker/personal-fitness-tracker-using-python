...
calories = pd.read_csv(r"C:\Users\aswin\OneDrive\Documents\personal_fitness_tracker.py\calories.csv")
exercise = pd.read_csv(r"C:\Users\aswin\OneDrive\Documents\personal_fitness_tracker.py\exercise.csv")
...
percentage = round(sum(boolean_body_temp) / len(boolean_body_temp), 2) * 100
st.write(f"You have a higher body temperature than {percentage}% of other people during exercise.")